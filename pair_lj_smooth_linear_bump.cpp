...
#include "stdio.h"
#include "stdlib.h"
#include "pair_lj_smooth_linear_bump.h"
#include "atom.h"
#include "comm.h"
#include "force.h"
...
PairLJSmoothLinearBump::PairLJSmoothLinearBump(LAMMPS *lmp) : Pair(lmp) {
...
PairLJSmoothLinearBump::~PairLJSmoothLinearBump()
{
  if (allocated) {
...
void PairLJSmoothLinearBump::compute(int eflag, int vflag)
{
...
void PairLJSmoothLinearBump::allocate()
{
  allocated = 1;
  int n = atom->ntypes;
...
void PairLJSmoothLinearBump::settings(int narg, char **arg)
{
...
void PairLJSmoothLinearBump::coeff(int narg, char **arg)
{
...
double PairLJSmoothLinearBump::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairLJSmoothLinearBump::write_restart(FILE *fp)
{
...
void PairLJSmoothLinearBump::read_restart(FILE *fp)
{
...
void PairLJSmoothLinearBump::write_restart_settings(FILE *fp)
{
...
void PairLJSmoothLinearBump::read_restart_settings(FILE *fp)
{
  int me = comm->me;
  if (me == 0) {
...
double PairLJSmoothLinearBump::single(int /*i*/, int /*j*/, int itype, int jtype,
                                  double rsq,
...
double PairLJSmoothLinearBump::single_hessian(int /*i*/, int /*j*/, int itype, int jtype, double rsq,
